...
4. **Banco:** o projeto usa POSTGRES por padrão. No Render o disco é efêmero (dados se perdem no redeploy). Para produção com dados persistentes, crie um **PostgreSQL** no Render e configure `DATABASE_URL` e `DB_CONNECTION=pgsql`.
